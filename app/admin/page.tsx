          ...
          {projectList.map((project) => (
            <div key={project.slug} className="glass-card p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <Link href={`/project/${project.slug}`} className="p-2 rounded-lg border border-border text-muted-foreground hover:text-primary hover:border-primary/30 transition-colors" aria-label="View">
                  <Pencil size={14} />
                </Link>
